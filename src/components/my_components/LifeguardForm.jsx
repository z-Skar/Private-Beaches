...
import ImageUploader from "components/my_components/ImageUploader";
...
const FormComponent = ({ selectedImage, setSelectedImage, subheading, heading,
                        description, submitButtonText, textOnLeft = false}) => {
